...
import { Search,Collect } from '../component/Loaders';

const Manual = ({navigation}) => {


  const [isLoading,setIsLoading] =useState(false) 
  const [collectLoader,setCollectLoader] = useState(false);
...
const [id,setID]=useState('');
 ...
 const submit = ()=>{
  setIsLoading(true)
  axios.get(`https://garbage-backend.onrender.com/api/user/${id}`)
 ...
 const collection= (garbageCollect)=>{
  ...
  if(!data.name || !data.email || !data.contact || !data.ward || !data.address || !garbageCollect){
        ...
        isLoading ? (
          ...
          showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.loginButton} onPress={()=>collection(true)}>
              <Text style={styles.loginButtonText} >Collected</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.loginButton} onPress={()=>collection(false)}>
              <Text style={styles.loginButtonText} >Not Collected</Text>
            </TouchableOpacity>
